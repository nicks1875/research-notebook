...
- Use with MCP AI agent to interpret the final results. Should advise user on the "why" of price predictions and allow further interrogation

**Dimensions**
- [[Sentiment]]: News, Reddit, Twitter, SEC Filings - Captures market psychology. What the public "thinks" and "feels" about a stock and the internal published reports on company health
-
...
-
- Company insider monitoring - tracking prominent members of a company for a stock ticker and tracking any stock positions they make. This could have useful information about how they feel about their own company - is it doing well, is it not, etc.
